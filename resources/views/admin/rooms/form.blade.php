...
{{--                    </div>--}}
                        ...
                        <div class="form-group custom-group mb-4 col-md-6">
                            <label class="form-label required-label">Số giường ngủ</label>
              ...
              <strong><% errors.price[0] %></strong>
                ...
                <div class="form-group custom-group mb-4">
                    ...
                    <textarea class="form-control ck-editor" ck-editor rows="5" ng-model="form.amentis"></textarea>
                    <span class="invalid-feedback d-block" role="alert">
                             <strong><% errors.amentis[0] %></strong>
                     </span>
                </div>
