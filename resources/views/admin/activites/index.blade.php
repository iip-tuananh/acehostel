...
<div ng-cloak>
    ...
    {{-- Form tạo mới --}}
    @include('admin.activites.create')
    @include('admin.activites.edit')
</div>
@endsection

@section('script')
@include('admin.activites.Activity')
<script>
    let datatable = new DATATABLE('table-list', {
		ajax: {
			url: '/admin/activites/searchData',
		...
		columns: [
            ...
            {data: 'count_images', title: 'Hình ảnh'},
    ...
    app.controller('Reviews', function ($rootScope, $scope, $http) {
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/activites/" + $scope.data.id + "/getDataForEdit",
                headers: {
