...
|| request()->is('admin/rooms*') || request()->is('admin/category-special*') || request()->is('admin/room-banner')
 ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('roomPages.edit') }}" class="nav-link {{ Request::routeIs('roomPages.edit') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Cấu hình banner</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/services') || request()->is('admin/services/*') || request()->is('admin/services')
|| request()->is('admin/services/*') || request()->is('admin/service-banner') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('servicePages.edit') }}" class="nav-link {{ Request::routeIs('servicePages.edit') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Cấu hình banner</p>
                        </a>
                    </li>
...
|| request()->is('admin/amenities/*') ? 'menu-open' : '' }} ">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/activites') || request()->is('admin/activites/*') || request()->is('admin/activites') || request()->is('admin/gallery-banner')
|| request()->is('admin/activites/*') ? 'menu-open' : '' }} ">
                <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('galleryPages.edit') }}" class="nav-link {{ Request::routeIs('galleryPages.edit') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Cấu hình banner</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('activites.index') }}" class="nav-link {{ Request::routeIs('activites.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục hình ảnh thư viện</p>
                        </a>
                    </li>
                </ul>
            </li>
...
{{--            </li>--}}
 ...
 request()->is('admin/origins') || request()->is('admin/manufacturers/*') || request()->is('admin/attributes') ? 'menu-open' : '' }} ">
