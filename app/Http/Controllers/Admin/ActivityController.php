...
use App\Model\Admin\Activiy as ThisModel;
...
{
    protected $view = 'admin.activites';
    protected $route = 'activites';
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ->addColumn('count_images', function ($object) {
                $count = $object->galleries()->count();
                $url = route('activites.addGallery', ['id' => $object->id]);
            ...
            ->addIndexColumn()
            ->rawColumns(['name','image','action', 'count_images'])
            ->make(true);
    }
    ...
    public function addGallery(Request $request,$id)
    {
        ...
        return view($this->view.'.add_gallery', compact('object'));
    }
