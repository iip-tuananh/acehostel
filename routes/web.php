...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'room-banner'], function () {
        Route::get('/', 'Admin\RoomBannerController@edit')->name('roomPages.edit');
        Route::post('/update', 'Admin\RoomBannerController@update')->name('roomPages.update');
    });

    Route::group(['prefix' => 'service-banner'], function () {
        Route::get('/', 'Admin\ServiceBannerController@edit')->name('servicePages.edit');
        Route::post('/update', 'Admin\ServiceBannerController@update')->name('servicePages.update');
    });


    Route::group(['prefix' => 'gallery-banner'], function () {
        Route::get('/', 'Admin\GalleryBannerController@edit')->name('galleryPages.edit');
        Route::post('/update', 'Admin\GalleryBannerController@update')->name('galleryPages.update');
    });
    ...
    Route::group(['prefix' => 'activites'], function () {
        Route::get('/', 'Admin\ActivityController@index')->name('activites.index');
        Route::get('/searchData', 'Admin\ActivityController@searchData')->name('activites.searchData');
        Route::get('/{id}/show', 'Admin\ActivityController@show')->name('activites.show');
        Route::get('/{id}/add-gallery', 'Admin\ActivityController@addGallery')->name('activites.addGallery');
        Route::get('/create', 'Admin\ActivityController@create')->name('activites.create');
        Route::post('/', 'Admin\ActivityController@store')->name('activites.store');
        Route::post('/{id}/update', 'Admin\ActivityController@update')->name('activites.update');
        Route::get('/{id}/delete', 'Admin\ActivityController@delete')->name('activites.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\ActivityController@getDataForEdit');
        Route::get('/exportExcel','Admin\ActivityController@exportExcel')->name('activites.exportExcel');
    });
